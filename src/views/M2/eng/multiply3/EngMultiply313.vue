...
<button id="Button1" type="button" class="collapsible bible">Read Acts 7:54-8:3</button><div class="collapsed" id ="Text1">
<!-- begin bible -->
...
<table border="1" class="video">
	<tbody class="video">
		<tr class="video">
			...
			<td class="video">Acts 8:1-3</td>
		</tr>
		<tr class="video">
			<td class="label video"><strong>URL:</strong></td>
			<td class="video">https://api.arclight.org/videoPlayerUrl?refId=2_529-Acts7319-0-0</td>
		</tr>
		<tr class="video">
