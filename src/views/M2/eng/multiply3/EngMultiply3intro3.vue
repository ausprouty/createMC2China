  ...
  <p>
        ...
        <div class="page pinch-zoom-parent offscreen" id="pinch-zoom-parent">
            ...
            <div class="pinch-zoom">
                <div><img  id="pinch-zoom-image"  src="@/assets/eng/multiply3/Trip1.png" /></div>
            </div>
        </div>
        <div id = "pinch-zoom0" onclick="zoomShow('0', '@/assets/eng/multiply3/Trip1.png', )">
             <img  alt="<img alt="" src="@/assets/eng/multiply3/Trip1.png" />
        </div></p>
