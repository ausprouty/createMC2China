...
<button id="Button1" type="button" class="collapsible bible">Read Luke 7:36-8:3</button><div class="collapsed" id ="Text1">
<!-- begin bible --><!-- end bible --><!-- begin bible -->
...
<table border="1" class="video">
	<tbody class="video">
		<tr class="video">
			...
			<td class="video">Luke 8:1-3</td>
		</tr>
		<tr class="video">
			<td class="label video"><strong>URL:</strong></td>
			<td class="video">https://api.arclight.org/videoPlayerUrl?refId=6_529-GOLuke2608</td>
		</tr>
		<tr class="video">
